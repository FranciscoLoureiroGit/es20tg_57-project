        ...
        >
            <v-card>
                ...
                >
                    ...
                    <span v-if="this.parentExtraClarification != null" class="subtitle-2">{{ questionDetails()}}</span>
                </v-card-subtitle>
...
<script lang="ts">
  ...
  export default class ExtraClarificationDialog extends Vue {
    ...
    createAnswerFormTitle() {
      if(this.parentExtraClarification)
        return 'Extra Clarification Answer';
      else
        return 'Extra Clarification Request';
    }
