      ...
      <div style="background-color: #d6d6d6">
        <template>
          <div class="container">
            ...
            <v-card-title
              style="font-weight: normal; font-size: 1.3vh; padding-left: 4vh"
              >{{ clarification.description }}</v-card-title
            >
            <br />
      ...
      <div v-if="clarification.clarificationAnswerDto && !questionId ">
        <template>
          <div class="container">
            ...
            <v-card-title
              style="font-weight: normal; font-size: 1.3vh; padding-left: 4vh"
              >{{ clarification.clarificationAnswerDto.answer }}</v-card-title
            >

            <!-- ADD LIST HERE -->
            <extra-clarification-list-dialog :clarification="clarification" />
...
export default class ClarificationDialogue extends Vue {
  ...
  extraCommentButtonStatus() {
    this.extraCommentEnable =
      this.clarification.extraClarificationDtos.length % 2 !== 0;
  }
