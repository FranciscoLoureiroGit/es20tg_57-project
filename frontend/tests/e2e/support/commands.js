...
// you should comment what it is you are trying to access when it is not obvious (selecting components that are auto-generated by vue)
...
Cypress.Commands.add(
  ...
  (numberOfQuestions, topicId) => {
    ...
    cy.contains('*Starting Date')
      ...
      .find('input')
      .click();
    cy.get('.v-dialog__content--active') // what is this?
